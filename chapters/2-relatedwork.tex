...
Another use case in this field is the restrictional use of a mutual resource that can only have a small number of users at a time. This can be achieved by u\todo{richtig zitieren}sing a token queue and a token semaphore, as from Makki et al.\cite{makki1992token}
